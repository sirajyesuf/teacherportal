...
class LessonController extends Controller
{
    ...
    {
        $notificationID = (int) $request->query("notification_id", null);
        if ($notificationID) {
            Notification::query()
    ...
    public function index(Request $request)
    {
        ...
        if ($lessons) {
            ...
            foreach ($lessons as $key => $value) {
                ...
                $trainer = $value->lessonHourLogs
                    ? $value->lessonHourLogs->user->first_name ??
                        $value->user->first_name
                    : $value->user->first_name;
                $color = $value->lessonHourLogs
                    ? $value->lessonHourLogs->user->color ??
                        $value->user->first_name
                    : $value->user->color;
                ...
                $html .=
                    ...
                    '" />';
                $html .=
                    '<input type="hidden" name="duplicate" class="duplicate" value="0" />';
                $html .=
                    '<div class="lesson-table pr-lg-2" id="sift' .
                    $value->id .
                    '">';
                $html .= '<div class="save-btn">';
                $html .=
                    '<button type="submit" class="orange-bg"><img src="' .
                    asset("images/download2.png") .
                    '" height="20"> Save</button>';
                $html .=
                    '<a href="javascript:void(0)" data-del-id="' .
                    $value->id .
                    '" class="del-lesson"><img src="' .
                    asset("images/delete-button.svg") .
                    '" alt="" class="del-les-img"></a>';
                $html .= "</div>";
                $html .=
                    '<table>
                            <tr>
                    ...
                    normal_case($tempName[0]) .
                    ':</label>
                                    <input type="text" class="datepicker1" id="' .
                    $tempName[0] .
                    "_" .
                    $value->id .
                    '" name="' .
                    ...
                    '" readonly>
                                    ...
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[2]) .
                    ':</label>
                                    <input type="number" step="0.25" name="' .
                    $tempName[2] .
                    '" placeholder="' .
                    normal_case($tempName[2]) .
                    ':" value="' .
                    ...
                    '" required>
                                ...
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[3]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[3] .
                    '" placeholder="' .
                    normal_case($tempName[3]) .
                    '" rows="10" cols="5" class="vestibular">' .
                    $tempValue[3] .
                    '</textarea>
                                </td>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[4]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[4] .
                    '" placeholder="' .
                    normal_case($tempName[4]) .
                    '" rows="10" cols="5" class="proprioception">' .
                    $tempValue[4] .
                    '</textarea>
                            ...
                            <tr>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[5]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[5] .
                    '" placeholder="' .
                    normal_case($tempName[5]) .
                    '" rows="10" cols="5" class="muscle_tone">' .
                    $tempValue[5] .
                    '</textarea>
                                </td>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[6]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[6] .
                    '" placeholder="' .
                    normal_case($tempName[6]) .
                    '" rows="10" cols="5" class="reflex">' .
                    $tempValue[6] .
                    '</textarea>
                                ...
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[7]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[7] .
                    '" placeholder="' .
                    normal_case($tempName[7]) .
                    '" rows="10" cols="5" class="kinestesia">' .
                    $tempValue[7] .
                    '</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[8]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[8] .
                    '" placeholder="' .
                    normal_case($tempName[8]) .
                    '" rows="5" cols="5" class="massage">' .
                    $tempValue[8] .
                    '</textarea>
                                </td>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[9]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[9] .
                    '" placeholder="' .
                    normal_case($tempName[9]) .
                    '" rows="5" cols="5" class="tactile">' .
                    $tempValue[9] .
                    '</textarea>
                                </td>
                                <td>
                                <label class="font-weight-bold">' .
                    normal_case($tempName[10]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[10] .
                    '" placeholder="' .
                    normal_case($tempName[10]) .
                    '" rows="5" cols="5" class="emotions">' .
                    $tempValue[10] .
                    '</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[11]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[11] .
                    '" placeholder="' .
                    normal_case($tempName[11]) .
                    '" rows="5" cols="5" class="vp">' .
                    $tempValue[11] .
                    '</textarea>
                                ...
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[12]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[12] .
                    '" placeholder="' .
                    normal_case($tempName[12]) .
                    '" rows="5" cols="5" class="ep">' .
                    $tempValue[12] .
                    '</textarea>
                                </td>
                                <td>
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[13]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[13] .
                    '" placeholder="' .
                    normal_case($tempName[13]) .
                    '" rows="5" cols="5" class="others">' .
                    $tempValue[13] .
                    '</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td rowspan="3" colspan="3">
                                    <label class="font-weight-bold">' .
                    normal_case($tempName[14]) .
                    ':</label>
                                    <textarea name="' .
                    $tempName[14] .
                    '" placeholder="' .
                    normal_case($tempName[14]) .
                    '" rows="5" cols="5" class="ft">' .
                    $tempValue[14] .
                    '</textarea>
                                </td>
                            </tr>
        ...
        return view(
            "lessons.index",
            compact("user", "lessons", "html", "q", "id")
        );
    }
        ...
        if ($lessons) {
            ...
            foreach ($lessons as $key => $value) {
                ...
                $html .=
                    '<input type="hidden" name="duplicate" class="duplicate" value="0" />';
                $html .=
                    '<div class="lesson-table pl-lg-2" id="btlang' .
                    $value->id .
                    '">';
                $html .= '<div class="save-btn">';
                $html .=
        ...
        if ($lessons) {
            ...
            foreach ($lessons as $key => $value) {
                ...
                $html .=
                    '<input type="hidden" name="duplicate" class="duplicate" value="0" />';
                $html .=
                    '<div class="lesson-table pl-lg-2" id="sand' .
                    $value->id .
                    '">';
                $html .= '<div class="save-btn">';
                $html .=
        ...
        if ($lessons) {
            ...
            foreach ($lessons as $key => $value) {
                ...
                $html .=
                    ...
                    '" />';
                $html .=
                    '<div class="lesson-table pl-lg-2" id="im' .
                    $value->id .
                    '">';
                $html .= '<div class="save-btn">';
                $html .=
                ...
                $html .=
                    ...
                    '">
                            ...
                            <tr class="bt-lang">
                                <td>
                                    <input type="text" class="truncated-text" title="' .
                    $tempValue[2] .
                    '" name="' .
                    $tempName[2] .
                    '" value="' .
    ...
    public function update(Request $request)
    {
        ...
        if (isset($request->student_id) && isset($request->update_id)) {
            ...
            $lesson_date = Carbon::createFromFormat(
                "d-m-Y",
                $request->date
            )->format("Y-m-d");
            ...
            $lessonLog = LessonLog::where("student_id", $request->student_id)
                ->where("lesson_date", $lesson_date)
                ->where("program", "SI/FT")
                ->where("deleted_at", null)
                ->first();

            $lessonLogNew = LessonLog::where(
                "lesson_id",
                $request->update_id
            )->first();
                ...
                foreach ($data as $key => $value) {
                    if ($k == $key) {
                        ...
                        if ($value) {
                            ...
                            while ($strCount > 0) {
                                $temp = preg_match('~href="\K\d+~', $str, $out)
                                    ? $out[0]
                                    : "";
                                $notIds[$count] = $temp;
            ...
            $lessonLogNew->created_by =
                $lessonLogNew->created_by ?? Auth::user()->id;
            ...
            // $hoursRemaining = $lessonService->getRemainingHour($request->student_id);
            // new code ends
        ...
        if ($model) {
            if ($model->created_by != $user->id && $user->role_type != "1") {
                return response()->json(
                    ["message" => "Only person who post can delete"],
                    422
                );
            }
        }
