...
@section('content')
    <main class="main-wrapper">
        ...
        <div class="search-bar">
            <p class="d-sm-none">Announcements</p>
            <div class="header-addbtn">
                ...
                <form action="{{ route('announcements.post') }}" method="POST">
                    @csrf
        ...
        <div class="menu-bar">
            <ul>
                ...
                @endif
                <li><a href="{{ route('announcements') }}" id="active">Announcements</a></li>
                ...
                <div class="col-md-12">
                    @if ($announcements)
                        @foreach ($announcements as $announ)
                            <div class="lesson-table pl-lg-2" id="{{"announcement".$announ->announcement_id}}">
                                <table class="im">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <input type="text" class="datepicker" placeholder="Date:"
                                                    value="{{ caseDateFormate($announ->announcement->created_at) }}"
                                                    readonly>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <span
                                                    style="background:{{ $announ->announcement->user->color ?? '' }};">{{ $announ->announcement->user->first_name ?? '' }}</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="lightgrey-bg" colspan="2">
                                            <div class="d-flex">
                                                ...
                                                @if ($announ->announcement->is_all)
                                                    <span>All</span>
                                                @else
                                                    <span>
                                                        @foreach ($announ->announcement->recipients as $recipient)
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <span>{{ $announ->announcement->title }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <span class="comments">{!! $announ->announcement->content !!}</span>
                                        </td>
                                    </tr>
                                </table>
                            </div>
