            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <form action="{{ route("casenote.updateCmm") }}" class="cmmform" method="POST">
                        ...
                        <div class="lesson-table pl-lg-2" id="{{"casemg".$caseMgmt->id}}">
                            <div class="save-btn">
                ...
                <div class="col-md-5">
                    ...
                    <form action="{{ route("casenote.updatePrs") }}" method="POST">
                        ...
                        <div class="lesson-table pl-lg-2" id="{{"parentreview".$parentreview->id}}">
                            <div class="save-btn">
                                <button type="submit"><img src="{{ asset('images/download.svg') }}" alt=""> Save</button>
                ...
                <div class="col-md-2">
                    ...
                    <form action="{{ route("casenote.updateCom") }}" method="POST">
                        ...
                        <div class="lesson-table pl-lg-2" id="{{"comm".$comment->id}}">
                            <div class="save-btn">
                                <button type="submit"><img src="{{ asset('images/download.svg') }}" alt=""> Save</button>
